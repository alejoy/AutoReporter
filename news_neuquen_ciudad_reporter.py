...
Elegí los 2 más relevantes para los vecinos de la ciudad de Neuquén capital. Priorizá servicios municipales, obras, transporte, seguridad barrial o economía local.
...
def generar_articulo(tema, fecha_hoy):
    prompt = f"""Sos un redactor periodístico para un portal de noticias de la ciudad de Neuquén, Argentina.
...
- La nota debe leerse como una pieza periodística municipal lista para publicar
