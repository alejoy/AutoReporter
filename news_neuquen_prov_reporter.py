...
Elegí los 2 más importantes para los neuquinos. Priorizá política provincial, economía, obras, salud o seguridad.
...
def generar_articulo(tema, fecha_hoy):
    prompt = f"""Sos un redactor periodístico para un portal de noticias de Neuquén, Argentina.
...
- La nota debe leerse como una pieza periodística lista para publicar
