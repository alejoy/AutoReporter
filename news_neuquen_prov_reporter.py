...
def seleccionar_temas(noticias, fecha_hoy):
    ...
    prompt = f"""Titulares de Neuquén provincia del {fecha_hoy}:

{titulares}

Elegí los 2 más relevantes para los neuquinos. Priorizá política, economía, obras, salud o seguridad.
...
def generar_articulo(titulo_sugerido, texto_fuente):
    prompt = f"""Sos un redactor periodístico para un portal de noticias regional argentino.
